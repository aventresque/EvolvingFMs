...
public class SATIBEA_SettingsIBEA extends Settings {
    ...
    public Algorithm configureASE2013(long maxRunTimeMS, GenerateReports gr) throws JMException {
        ...
        algorithm = new IBEATimeLimited(problem_,maxRunTimeMS, gr);
    ...
    public Algorithm configureSATIBEA(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr, GenerateReports gr) throws JMException {
